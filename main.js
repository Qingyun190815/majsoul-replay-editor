...
function init() {
    try {
        ...
        if (unsafeWindow.paishan != null) {
            paishan = unsafeWindow.paishan;
            unsafeWindow.paishan = null;
        }
        if (unsafeWindow.discardtiles != null) {
            discardtiles = unsafeWindow.discardtiles;
            unsafeWindow.discardtiles = null;
        }
        if (unsafeWindow.muyuseats != null) {
            muyuseats = unsafeWindow.muyuseats;
...
function gamebegin() {
    try {
        if (unsafeWindow.editdata != null) {
            editdata = unsafeWindow.editdata;
            unsafeWindow.editdata = null;
        }
        if (unsafeWindow.settings != null) {
