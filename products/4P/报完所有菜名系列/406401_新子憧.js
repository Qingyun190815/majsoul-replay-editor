...
editdata.player_datas[0].nickname = "新子憧-契约";
editdata.player_datas[1].nickname = "新子憧";
editdata.player_datas[2].nickname = "新子憧-契约";
editdata.player_datas[3].nickname = "兔耳派对";
editdata.player_datas[0].avatar_id = 406402;
editdata.player_datas[1].avatar_id = 406401;
editdata.player_datas[2].avatar_id = 406402;
editdata.player_datas[3].avatar_id = 406403;
...
tiles1 = "222255508888s7z";
tiles2 = "3333444467777s";
paishan = randompaishan("1p1p1p9p", "4z2p8p2p8p2p8p2p8p6z7z2z5z1z");
roundbegin();
qiepai("1p", true);
mopai();
qiepai();
...
tiles1 = "1222333444456p";
tiles2 = "123456789m1p333z";
tiles3 = "2367788889999p";
paishan = randompaishan("","5z6z6z6z6z");
roundbegin();
qiepai("1p");
hupai();
