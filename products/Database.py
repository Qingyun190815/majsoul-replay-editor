...
char_unique_views = {
    ...
    20000107: generate_frame(30550022) + generate_views([0, 5, 6, 7], [30560007, 30550022, 30580015, 30570009]),
}
...
char_unique_views_3P = {
    ...
    # 元宵: 立直棒-青竹伞; 头像框-竹福滚滚; 桌布-清辉竹影; 牌背-翠竹墨影
    20000107: generate_frame(30550022, 3) + generate_views([0, 5, 6, 7], [30560007, 30550022, 30580015, 30570009], 3),
}
