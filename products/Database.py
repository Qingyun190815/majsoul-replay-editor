...
nicknames = [
    ...
    ["相原舞", "相原舞-契约", "海滩派对", "昭华年", "禁锢之地", "温存韶光", "异想烂漫"],
    ["抚子", "抚子-契约", "海滩派对", "细雪呈瑞", "四方雀者", "无拘乐趣"],
    ["八木唯", "八木唯-契约", "圣诞嘉年华", "魇魔之约", "月夜华尔兹", "悸动之夏", "四方雀者", "异想烂漫"],
    ["九条璃雨", "九条璃雨-契约", "海滩派对", "瑞雪迎新", "魂色幻想", "心跳时速"],
    ["泽尼娅", "泽尼娅-契约", "化妆舞会", "清凉夏日", "绮春歌", "异想烂漫"],
    ["卡维", "卡维-契约", "命运之夏", "拂晓的G大调"],
    ["四宫夏生", "四宫夏生-契约", "化妆舞会", "细雪呈瑞", "悸动之夏"],
    ["汪次郎", "汪次郎-契约", "化妆舞会", "假日之滨", "冬日心愿簿"],
    ["一之濑空", "一之濑空-契约", "圣诞嘉年华", "春日返校季", "绮春歌", "不寐之绊"],
    ["明智英树", "明智英树-契约", "魇魔之约", "命运之夏", "佳期不负"],
    ["轻库娘", "轻库娘-契约", "清凉夏日"],
    ["莎拉", "莎拉-契约", "新年初诣", "春日返校季", "悸动之夏", "四方雀者"],
    ["二之宫花", "二之宫花-契约", "万象沐春", "命运之夏", "馥郁满室", "冬日心愿簿"],
    ["白石奈奈", "白石奈奈-契约", "清凉夏日", "馥郁满室", "冬日心愿簿"],
    ...
    ["福姬", "福姬-契约", "春池小憩", "甜蜜魔法", "假日之滨", "异想烂漫"],
    ["七夕", "七夕-契约", "悸动之夏", "四方雀者"],
    ["蛇喰梦子", "蛇喰梦子-契约", "百花缭乱"],
    ["早乙女芽亚里", "早乙女-契约", "百花缭乱"],
    ["生志摩妄", "生志摩妄-契约", "百花缭乱"],
    ["桃喰绮罗莉", "桃喰绮罗莉-契约", "百花缭乱"],
    ["七海礼奈", "七海礼奈-契约", "白色礼赞", "枕边私语", "云窗春几枝"],
    ["A-37", "A-37-契约", "花火之约", "醇香初夏", "不寐之绊"],
    ["姬川响", "姬川响-契约", "新岁添喜", "奇遇星光"],
    ["莱恩", "莱恩-契约", "甜蜜魔法", "天黑请闭眼"],
    ["森川绫子", "森川绫子-契约", "满分假期", "拂晓的G大调", "不寐之绊"],
...
avatar_ids = [
    ...
    [400501, 400502, 400503, 400504, 400505, 400506, 400507],  # 相原舞
    [400601, 400602, 400603, 400604, 400605, 400606],  # 抚子
    [400701, 400702, 400703, 400704, 400705, 400706, 400707, 400708],  # 八木唯
    [400801, 400802, 400803, 400804, 400805, 400806],  # 九条璃雨
    [400901, 400902, 400903, 400904, 400905, 400906],  # 泽尼娅
    [401001, 401002, 401003, 401004],  # 卡维
    [401101, 401102, 401103, 401104, 401105],  # 四宫夏生
    [401201, 401202, 401203, 401204, 401205],  # 汪次郎
    [401301, 401302, 401303, 401304, 401305, 401306],  # 一之濑空
    [401401, 401402, 401403, 401404, 401405],  # 明智英树
    [401501, 401502, 401503],  # 轻库娘
    [401601, 401602, 401603, 401604, 401605, 401606],  # 莎拉
    [401701, 401702, 401706, 401707, 401708, 401709],  # 二之宫花
    [401801, 401802, 401803, 401804, 401805],  # 白石奈奈
    ...
    [402601, 402602, 402603, 402604, 402605],  # 雏桃
    ...
    [403801, 403802, 403803, 403804, 403805, 403806],  # 福姬
    ...
    [404401, 404402, 404403, 404404, 404405],  # 七海礼奈
    [404501, 404502, 404503, 404504, 404505],  # A-37
    [404601, 404602, 404603, 404604],  # 姬川响
    [404701, 404702, 404703, 404704],  # 莱恩
    [404801, 404802, 404803, 404804, 404805],  # 森川绫子
    ...
    [406801, 406802, 406803, 406804],  # 如月彩音
    ...
    [409501, 409502],  # 南枫花
    [409601, 409602],  # 非名
    [40010001, 40010002, 40010003],  # 浅仓透
    [40010101, 40010102, 40010103],  # 樋口圆香
    [40010201, 40010202, 40010203],  # 福丸小糸
    [40010301, 40010302, 40010303],  # 市川雏菜
    [40010701, 40010702],  # 元宵
]
...
views_names = {
    ...
    2: liqi_names,
    3: hand_names,
    5: avatar_frame_names,
    6: tablecloth_names,
    7: mjpai_names,
    13: mjp_surface_names,
}
...
def generate_frame(frame_id, player_num=4):
    ...
    return '// ' + avatar_frame_names[frame_id] + '\n' + temp + str(frame_id) + ';\n'
...
def generate_views(slots, item_ids, player_num=4):
    ...
    for index in range(len(slots)):
        result += ('    {"slot": ' + str(slots[index]) + ', "item_id": ' + str(item_ids[index]) + '}, // ' +
                   views_names[slots[index]][item_ids[index]] + '\n')
    result += '];'
    return result


def generate_frame_only(frame_id, player_num=4):
    return generate_frame(frame_id, player_num) + generate_views([5], [frame_id], player_num)
...
char_unique_views = {
    ...
    ### 常驻角色
    # 一姬: 立直棒-炎夏型一姬甜筒; 和牌-疾月斩; 立直-猫过留痕; 桌布-吃瓜; 牌面-猫咪雀圣
    200001: generate_views([0, 1, 2, 6, 13], [305049, 305213, 305324, 305046, 305718]),
    # 二阶堂美树: 桌布-藤萝悦色
    200002: generate_views([6], [305818]),
    # 藤田佳奈: 桌布-雀魂祭一周年
    200003: generate_views([6], [305048]),
    # 三上千织: 头像框-大小姐发带; 桌布-冲鸭！
    200004: generate_frame(305552) + generate_views([5, 6], [305552, 305802]),
    # 相原舞: 桌布-冲鸭！
    200005: generate_views([6], [305804]),
    # 抚子: 桌布-雀魂祭一周年
    ...
    # 汪次郎: 桌布-中光波——————！
    200012: generate_views([6], [305810]),
    # 明智英树: 桌布-中光波——————！
    ...
    # 五十岚阳菜: 头像框-猫咪军团的身份
    200020: generate_frame_only(305523),
    # 雏桃: 桌布-贺华岁
    200026: generate_views([6], [305804]),
    # 辉夜姬: 桌布-预热开场
    200029: generate_views([6], [30580005]),
    # 艾丽莎: 桌布-预热开场
...
char_unique_views_3P = {
    ...
    ### 常驻角色
    # 一姬: 立直棒-炎夏型一姬甜筒; 和牌-疾月斩; 立直-猫过留痕; 桌布-吃瓜; 牌面-猫咪雀圣
    200001: generate_views([0, 1, 2, 6, 13], [305049, 305213, 305324, 305046, 305718], 3),
    # 二阶堂美树: 桌布-藤萝悦色
    200002: generate_views([6], [305818], 3),
    # 藤田佳奈: 桌布-雀魂祭一周年
    200003: generate_views([6], [305048], 3),
    # 三上千织: 头像框-大小姐发带; 桌布-冲鸭！
    200004: generate_frame(305552, 3) + generate_views([5, 6], [305552, 305802], 3),
    # 相原舞: 桌布-冲鸭！
    200005: generate_views([6], [305804], 3),
    # 抚子: 桌布-雀魂祭一周年
