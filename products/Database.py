...
paipu_uuids = [
    ...
    "240824-6cc115df-e972-4d7a-9f16-32a1c52e92b8",  # 1 男性手
    "240816-a0cd14b8-4df6-49d6-b13a-f94955ab471d",  # 2 男性手-深色
    "240822-4b832cf6-1310-41e8-9379-ee3179a3dedd",  # 3 手-深色
    "210429-9171010b-679d-4ee6-af18-44ade99be7e1",  # 4 手-狂赌联动
    "211102-36501f8b-d854-42a8-b827-5f7ca300b2e8",  # 5 手-斗牌联动
    "240808-28d4bd69-6322-4b16-9eba-2f8d29f2e8f8",  # 6 手-汉娜
    "240824-e51bd94e-459a-491e-97b5-5047613ec898",  # 7 手-穆萨
    "241125-fb7ea56d-a854-4ba0-8f16-202757a56ba5",  # 8 手-Noctchill
]
...
dict_spchar_paipu = {
    ...
    200092: paipu_uuids[1],  # 局
    200096: paipu_uuids[1],  # 非名
    20000100: paipu_uuids[8],  # 浅仓透
    20000101: paipu_uuids[8],  # 樋口圆香
    20000102: paipu_uuids[8],  # 福丸小糸
    20000103: paipu_uuids[8],  # 市川雏菜
}
...
""" use_dict 和 use_views
这两个是选择使用哪种方式来实现 使用非一般手模的角色 的牌谱, 只有当自己为 True, 另一个为 False 时, 该功能才生效
考虑再三, 在这里使用第一个变量
...
use_views:
True 表示修改角色的手模为一般手模(通过修改装扮 views 里面 "slot": 3 手的样式 的方式)
